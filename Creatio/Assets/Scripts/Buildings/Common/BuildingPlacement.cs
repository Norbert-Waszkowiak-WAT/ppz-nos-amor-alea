    ...
    void Build(GameObject buildingType)
{
    ...
    created.GetComponent<Building>().SetManager(this, UImanager.GetComponent<UIManager>());

    // Przypisz UIManager do prefabów
    // Building buildingScript = created.GetComponent<Building>();
    // if (buildingScript != null && uiManager != null)
    // {
    //     buildingScript.SetUIManager(uiManager); // Przekazanie referencji do UIManager
    // }
    ...
    void CreateBelt()
{
    ...
    //UIManager do prefabów
    // Building buildingScript = createdBelt.GetComponent<Building>();
    // if (buildingScript != null && uiManager != null)
    // {
    //     buildingScript.SetUIManager(uiManager);
    // }
